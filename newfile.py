...
def home_page():
    ...
    st.markdown(
        "<h2 style='text-align: center; color: white; font-family:Arial; font-weight:bold; text-decoration: underline;'>Comprehensive System for Alzheimer's Disease Diagnoses</h2>",
        unsafe_allow_html=True
    )
